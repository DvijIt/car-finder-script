...
# Налаштування
TOKEN = "8130712293:AAGGtMKNrahY9ygqpuG8aOsVR0zZCEL98Xk"
CHAT_ID = "7239075479"

PRICE_FILTER_MIN = 1500
PRICE_FILTER_MAX = 3500
JSON_FILE = "all_cars_data.json"
...
def get_latest_cars():
    url = "https://www.kleinanzeigen.de/s-autos/22941/preis::3000/c216l903r100+autos.ez_i:2000%2C"
    driver.get(url)
    ...
    articles = driver.find_elements(
        By.CLASS_NAME, "aditem"
    )  # Приклад. Вкажіть правильний селектор
    ...
    for article in articles:
        ...
        price = article.find_element(
            By.CLASS_NAME, "aditem-main--middle--price-shipping--price"
        ).text
...
def parseDateSavedCars():
    ...
    for car in cars.values():
        cars[car["id"]]["date"] = parse_date(cars[car["id"]]["date"]).strftime(
            "%d.%m.%Y"
        )
